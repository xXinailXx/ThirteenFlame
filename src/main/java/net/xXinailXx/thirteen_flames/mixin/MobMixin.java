...
public abstract class MobMixin {
    ...
    protected boolean canReplaceCurrentItem(ItemStack stack, ItemStack stack1) {
        if (stack1.isEmpty()) {
            ...
            return this.canReplaceEqualItem(stack, stack1);
        } else if (stack.getItem() instanceof ArmorItem || stack.getItem() instanceof ArmorItemTF) {
            if (EnchantmentHelper.hasBindingCurse(stack1)) {
                return false;
            } else if (!(stack1.getItem() instanceof ArmorItem) || !(stack1.getItem() instanceof ArmorItemTF)) {
                return true;
