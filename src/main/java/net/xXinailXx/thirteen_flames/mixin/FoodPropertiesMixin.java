...
public class FoodPropertiesMixin {
    ...
    public float getSaturationModifier() {
        return (float) (this.saturationModifier * ((data.isActiveAbility(Minecraft.getInstance().player, "diet") ? (data.getLevelAbility(Minecraft.getInstance().player, "diet") + 1) * 0.05 : 0) + 1));
    }
}
