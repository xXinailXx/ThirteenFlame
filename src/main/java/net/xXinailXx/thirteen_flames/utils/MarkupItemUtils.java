...
public class MarkupItemUtils extends ItemSetting {
    ...
    public MarkupItemUtils(Gods gods) {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        if (player.isShiftKeyDown() && player.getItemInHand(hand).getTag() != null)
            Network.sendToAll(new DiscardShcemeEntityPacket(player.getItemInHand(hand)));
    ...
    public InteractionResult useOn(UseOnContext use) {
        ...
        Network.sendToAll(new DiscardShcemeEntityPacket(stack));
