...
public class StatueMontu extends StatueHendler {
    @Override
    ...
    public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return BlockEntityRegistry.STATUE_MONTU_BLOCK_ENTITY.get().create(pos, state);
    }
...
//        getBlocksList(mainPos, true).forEach(blockPos -> level.setBlock(blockPos, BlockRegistry.STATUE_MONTU_STRUCTURE_BLOCK.get().defaultBlockState(), 5));
